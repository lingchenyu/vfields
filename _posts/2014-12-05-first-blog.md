...
###一个loading
&nbsp; &nbsp; 挺喜欢的一个小动画，本来打算弄成<code>gif</code>用于网站的<code>loading</code>，但折腾了几天，发现效果都不太好，终于决定放！弃！了！！！多么痛的领悟！！！
...
###出师未捷的blog主题
&nbsp; &nbsp; 同时，也为我之前折腾了很久的<code>wordpress</code>主题做个纪念，毕竟折腾了那么久，但最后却选择了<code>jekyll</code>。。。
<img src="/images/20141205/2014-12-05_test01.png" alt="出师未捷的blog" height="100%"/>

###关于这个网站
&nbsp; &nbsp; 嗯，现在做的还比较烂，而且还用了其他人的框架来改，除了头尾，基本已经被我改得面目全非了= =。但总有一天，我会自己去搞一个的。至于这个名字，来源于一首歌的名字，也是我一直在用的铃声。这个网站的诞生主要是为了练习<code>js</code>和<code>css</code>，还有一些关于域名的东西，为以后做管理后台神马的做点准备。而且其实<code>jekyll</code>写blog就跟写代码一样，个人还是比较喜欢的，虽然神马都要自己动手去折腾好久好久好久好久。。。。~~~~(>_<)~~~~
